...
//   add(c) {
//     try {
//       if (!(c instanceof Color)) throw "Color.add: non-color parameter";
//       else {
//         this.r += c.r;
//         this.g += c.g;
//         this.b += c.b;
...
//   subtract(c) {
//     try {
//       if (!(c instanceof Color)) throw "Color.subtract: non-color parameter";
//       else {
//         this.r -= c.r;
//         this.g -= c.g;
//         this.b -= c.b;
...
//   scale(s) {
//     try {
//       if (typeof s !== "number") throw "scale factor not a number";
//       else {
//         this.r *= s;
//         this.g *= s;
//         this.b *= s;
...
//   copy(c) {
//     try {
//       if (!(c instanceof Color)) throw "Color.copy: non-color parameter";
//       else {
//         this.r = c.r;
//         this.g = c.g;
//         this.b = c.b;
...
//     drawPixel.numExcepts =
//       drawPixel.numExcepts == "undefined" ? 0 : drawPixel.numExcepts;
//     if (drawPixel.numExcepts++ < 10) console.log(e);
//   }
// } // end drawPixel
...
//   } else {
//     // end if e1 largest min Y, begin e2 largest min Y
...
//   } else {
//     // end if e1 largest max Y, begin e2 largest max Y
...
//         throw "twoEdgeInterp: intersecting edges!";
//         break;
...
//   var minYList = vArray.map(function (vtx, idx, ary) {
//     // create array of minY index pairs
//     return {
//       minY: Math.min(vtx.y, vArray[(idx + 1) % vArray.length].y),
//       index: idx,
//     };
//   });
//   minYList.sort(function (e1, e2) {
//     // sort array by minY
...
//   var e1 = 0,
//     e2 = 1; // begin with first two edges (those that begin first/have min two Ys)
//   var e1v1, e1v2, e2v1, e2v2; // the vertices included in these two edges
//   while (e2 < sortedNoHzEdges.length) {
//     // for each polygon vertex index in sorted filtered list
...
//     h = imagedata.height; // viewport size

//   for (var v = 0; v < poly.length; v++) {
//     // for each poly vertex
//     eyePointSlope = Vector.subtract(
//       new Vector(poly[v].x, poly[v].y, poly[v].z),
//       view.eye
//     );
...
//         isectT = num / denom;
//         if (isectT < 0)
//           // one vertex behind eye
//           throw "one vertex behind eye!";
//         else {
//           // intersecton in front of eye
//           ctrToIsect = Vector.subtract(
//             Vector.add(view.eye, Vector.scale(isectT, eyePointSlope)),
//             planeCenter
//           );
